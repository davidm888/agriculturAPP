...
/**
* @class Application
* @author David Montoya <davidm@utp.edu.co>
* @description
...
class Application {
    ...
    */
    private initializeApp() {
      this.app = angular.module("agricultur-app", [
        "agricultur-app.Options", // Modulo de opciones de configuración de la app configs.angular
