...
//  setTimeout(function(){electron.reload();}, 4000);
//});
...
gulp.task("copy", ["typeScript"], () => {
  gulp.src("./app/webapp/css/fonts/**").pipe(gulp.dest("./public/css/fonts"));
  gulp.src("./app/webapp/css/lib/**/*.css").pipe(gulp.dest("./public/css/lib"));
  gulp.src("./app/webapp/js/lib/**/*.js").pipe(gulp.dest("./public/js/lib")); 
  gulp.src("./app/webapp/js/*.js").pipe(gulp.dest("./public/js/lib"));
